...
document.addEventListener("click", (e) => {
    if (e.target.classList.contains("menu")) {
      ...
      console.log("Button Pressed is: "+ chosenButton);    
      if(chosenButton=="All"){
        console.log("In All Button");    
        browser.tabs.query({
            active: true,
          ...
          .then(tab => {
            ...
            var aray = browser.tabs.executeScript({
              file: "../contentscripts/downloader.js"
            });
            aray.then(onLinksReceived, onError);
          });
        return;
      }
      else if(chosenButton=="Single"){
        console.log("In Single Button");    
